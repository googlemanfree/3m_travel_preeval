...
import { Search, ChevronDown, MessageCircle, Globe } from 'lucide-react';
...
const fullEvisasDatabase: Evisa[] = [
  ...
  // NOUVEAUX PAYS VÉRIFIÉS (éligibilité confirmée pour passeport camerounais —
  // frais et délais à reconfirmer avant publication finale, non garantis avec précision)
  { country: "Albanie", flag: "🇦🇱", region: "Europe", type: "e-Visa Électronique", duration: "Selon type", delay: "3-5 jours", docs: "Passeport, Photo d'identité, Justificatif d'hébergement", fee: "À confirmer", note: "Éligibilité confirmée pour passeport camerounais — frais à valider avec un conseiller." },
  { country: "Afrique du Sud", flag: "🇿🇦", region: "Afrique", type: "e-Visa Électronique", duration: "Selon type", delay: "5-10 jours", docs: "Passeport, Photo, Justificatif financier", fee: "À confirmer", note: "Éligibilité confirmée pour passeport camerounais — frais à valider avec un conseiller." },
  { country: "Ghana", flag: "🇬🇭", region: "Afrique", type: "Visa à l'arrivée", duration: "Selon type", delay: "Sur place", docs: "Passeport, Billet retour, Justificatif d'hébergement", fee: "À confirmer", note: "Visa délivré à l'arrivée pour passeport camerounais — conditions à reconfirmer avant voyage." },
  { country: "Sénégal", flag: "🇸🇳", region: "Afrique", type: "Visa à l'arrivée", duration: "Selon type", delay: "Sur place (aéroport de Dakar)", docs: "Passeport, Billet retour, Carnet de vaccination fièvre jaune", fee: "À confirmer", note: "Visa à l'arrivée disponible à l'aéroport de Dakar uniquement." },
  { country: "Île Maurice", flag: "🇲🇺", region: "Afrique", type: "Visa à l'arrivée", duration: "Selon type", delay: "Sur place", docs: "Passeport, Billet retour, Réservation hôtel", fee: "À confirmer", note: "Éligibilité confirmée pour passeport camerounais." },
  { country: "Malaisie", flag: "🇲🇾", region: "Asie", type: "e-Visa Électronique", duration: "Selon type", delay: "3-5 jours", docs: "Passeport, Photo, Réservation hôtel/billet", fee: "À confirmer", note: "Éligibilité confirmée pour passeport camerounais — frais à valider avec un conseiller." },
  { country: "Kazakhstan", flag: "🇰🇿", region: "Asie", type: "e-Visa Électronique", duration: "Selon type", delay: "3-5 jours", docs: "Passeport, Photo, Lettre d'invitation si requise", fee: "À confirmer", note: "Éligibilité confirmée pour passeport camerounais — frais à valider avec un conseiller." },
  { country: "Botswana", flag: "🇧🇼", region: "Afrique", type: "e-Visa Électronique", duration: "Selon type", delay: "3-5 jours", docs: "Passeport, Photo, Justificatif d'hébergement", fee: "À confirmer", note: "Éligibilité confirmée pour passeport camerounais — frais à valider avec un conseiller." },
  { country: "RD Congo", flag: "🇨🇩", region: "Afrique", type: "e-Visa Électronique", duration: "Selon type", delay: "3-5 jours", docs: "Passeport, Photo, Justificatif d'hébergement", fee: "À confirmer", note: "Éligibilité confirmée pour passeport camerounais — frais à valider avec un conseiller." },
  { country: "Bangladesh", flag: "🇧🇩", region: "Asie", type: "Visa à l'arrivée", duration: "Selon type", delay: "Sur place", docs: "Passeport, Billet retour, Justificatif d'hébergement", fee: "À confirmer", note: "Visa délivré à l'arrivée pour passeport camerounais — conditions à reconfirmer avant voyage." },
...
export default function Evisas() {
  ...
  const openWhatsApp = (country: string) => {
    ...
    window.open(`https://wa.me/237671234567?text=${encodedMessage}`, '_blank');
  };
