      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        >
          <div className="absolute inset-0 z-0">
            ...
            /> : <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-slate-950 via-blue-900 to-cyan-800 text-[11rem] opacity-55" aria-hidden="true">{destination.flag}</div>}
