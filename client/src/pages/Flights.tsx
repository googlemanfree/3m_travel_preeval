...
export default function AdminAccompagnement() {
  ...
  const { data: evalsData, isLoading: evalsLoading, refetch: refetchEvals } = trpc.admin.getEvaluationsAwaitingContact.useQuery({ sessionToken: localStorage.getItem("adminSessionToken") || "" });

  // Récupérer les statistiques globales
  const { data: statsData, isLoading: statsLoading } = trpc.admin.getGlobalStats.useQuery({ sessionToken: localStorage.getItem("adminSessionToken") || "" });
