              ...
              <div>
                ...
                <div className="relative h-48 overflow-hidden bg-slate-900">
                  {destination.image ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-blue-950 via-blue-800 to-indigo-700 text-7xl" aria-label={`Drapeau de ${destination.country}`}>
                      {destination.flag}
                    </div>
                  )}
