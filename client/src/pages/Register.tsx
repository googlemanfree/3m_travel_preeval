          ...
          <form onSubmit={handleSubmit} className="space-y-4" aria-busy={registerMutation.isPending || isUploadingPortrait || showSuccessAnimation}>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="group relative">
                <button type="button" aria-disabled="true" aria-describedby="register-google-coming-soon" onClick={(event) => event.preventDefault()} className="h-11 w-full flex items-center justify-center gap-2 px-4 border border-gray-200 rounded-lg text-sm font-medium text-gray-500 opacity-60 cursor-not-allowed">
                ...
                <span id="register-google-coming-soon" role="tooltip" className="pointer-events-none absolute left-1/2 top-full z-10 mt-2 -translate-x-1/2 whitespace-nowrap rounded bg-slate-900 px-2 py-1 text-xs text-white opacity-0 transition-opacity group-hover:opacity-100 group-focus-within:opacity-100">Bientôt disponible</span>
              </div>
              <div className="group relative">
