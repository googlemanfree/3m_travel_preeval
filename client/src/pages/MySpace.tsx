          ...
          <TabsContent value="agreement" className="space-y-6">
            <Card className="border-blue-100 shadow-sm">
              ...
              <CardContent className="space-y-5">
                {!dossierData?.data?.hasActiveDossier ? (
                  <div className="rounded-xl border border-blue-200 bg-blue-50 p-5 text-blue-950" role="status">
                    <p className="font-semibold">Pas encore de dossier actif</p>
                    <p className="mt-2 text-sm leading-6">Votre compte préliminaire est bien enregistré, mais aucun dossier officiel n’a encore été ouvert et confirmé par 3M Travel &amp; Services. Le protocole d’accord ne peut pas être signé à cette étape.</p>
                    <p className="mt-2 text-sm leading-6">Après validation de votre évaluation, confirmation du paiement d’ouverture et activation par l’administration, votre dossier officiel apparaîtra ici avec les instructions de signature.</p>
                  </div>
                ) : app?.agreementSigned ? (
