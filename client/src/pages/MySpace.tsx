...
export default function AdminEvaluation() {
  ...
  const { data: reportsData, isLoading: reportsLoading, refetch: refetchReports } = trpc.admin.getEvaluationPendingReports.useQuery({ sessionToken: localStorage.getItem("adminSessionToken") || "" });

  // Récupérer les statistiques
  const { data: statsData, isLoading: statsLoading } = trpc.admin.getEvaluationStats.useQuery({ sessionToken: localStorage.getItem("adminSessionToken") || "" });
