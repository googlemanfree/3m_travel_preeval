                    ...
                    <article key={notification.id} className={`rounded-xl border p-4 ${notification.isRead ? "border-slate-200 bg-white" : "border-blue-200 bg-blue-50/60"}`}>
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                        ...
                        <div className="flex flex-wrap gap-2 sm:justify-end">
                          ...
                          {notification.type === "payment_action_required" && <div className="w-full rounded-lg border border-amber-300 bg-amber-50 p-3 text-sm text-amber-950 sm:w-auto">
                            <p className="font-semibold">Motif communiqué par l’administration</p>
                            <p className="mt-1 text-xs leading-relaxed">{notification.body}</p>
                            <label htmlFor={`payment-correction-${notification.id}`} className="mt-3 inline-flex min-h-9 cursor-pointer items-center justify-center rounded-md bg-amber-600 px-3 py-2 text-sm font-semibold text-white transition hover:bg-amber-700 focus-within:ring-2 focus-within:ring-amber-500">
