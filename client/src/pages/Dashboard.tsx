                    ...
                    <>
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        {[
                          ...
                          { id: "dossier_status", label: "Statut du dossier", value: profile?.dossierStatus ? STATUS_CONFIG[profile.dossierStatus]?.label || profile.dossierStatus : "Nouveau", icon: FileText },
                        ].map((item) => (
