                ...
                <CardContent>
                  {activeDossier?.agreementSigned ? (
                    ...
                    <div className="space-y-4">
                      <div className="max-h-56 overflow-y-auto rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm leading-6 text-slate-700" tabIndex={0} aria-label="Texte du protocole d’accord"><p className="font-bold text-slate-950">Protocole d’accord — 3M Travel &amp; Services SARL</p>{INITIAL_AGREEMENT_PROTOCOL.split("\\n\\n").map((paragraph, index) => <p key={index} className="mt-2 whitespace-pre-line">{paragraph}</p>)}</div>
