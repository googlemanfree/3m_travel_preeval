        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-2 space-y-2">
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-3 px-4 rounded-lg transition-all shadow-sm"
            >
              ...
              Envoyer les détails par WhatsApp au conseiller
            </button>
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-all shadow-sm"
            >
              <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-6V6l8 5 8-2v2z"/>
              </svg>
              Envoyer les détails par e-mail au conseiller
            </button>
          </div>
        </form>
