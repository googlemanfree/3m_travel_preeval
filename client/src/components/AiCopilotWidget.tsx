...
const WELCOME_MESSAGE: ChatMessage = {
  role: "assistant",
  content:
    "Bonjour ! Je suis le Copilote IA 3M Travel 🤖 Je peux répondre à vos questions sur nos évaluations, les visas et les destinations. Comment puis-je vous aider ?",
};
        ...
        <AnimatePresence>
          {!isOpen && (
            <motion.button
              ...
              aria-label="Ouvrir le Copilote IA 3M Travel"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 w-[90vw] max-w-sm h-[70vh] max-h-[560px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200"
          >
            {/* En-tête */}
