  ...
  return <footer className="mt-auto bg-[#061a36] text-slate-100" aria-label="Informations et contacts 3M Travel"><div className="mx-auto max-w-7xl px-4 py-6 sm:py-8">
    ...
    <section aria-labelledby="footer-phone-title" className="mx-auto my-5 max-w-3xl rounded-2xl border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-blue-950/40 px-4 py-5 text-center shadow-xl shadow-black/10 sm:px-6">
      ...
      <div className="mx-auto mt-4 grid max-w-2xl gap-3 sm:grid-cols-2">
        <a href={`tel:${COMPANY_CONTACTS.yaounde.phone.replace(/\s/g, "")}`} className="group/phone rounded-xl border border-white/15 bg-[#0f2c5c]/80 px-4 py-3 text-left transition hover:-translate-y-0.5 hover:border-blue-200/60 hover:bg-[#163d78] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-300">
          ...
          <span className="mt-1 flex items-center justify-center gap-2 text-lg font-bold text-white sm:justify-start"><Phone className="h-4 w-4 text-blue-200 transition-transform group-hover/phone:scale-110" aria-hidden="true" />{COMPANY_CONTACTS.yaounde.phone}</span>
        </a>
        <a href={`tel:+${OFFICE_CONTACTS.ottawa.whatsappNumber}`} className="group/phone rounded-xl border border-white/15 bg-[#0f2c5c]/80 px-4 py-3 text-left transition hover:-translate-y-0.5 hover:border-blue-200/60 hover:bg-[#163d78] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-300">
          ...
          <span className="mt-1 flex items-center justify-center gap-2 text-lg font-bold text-white sm:justify-start"><Phone className="h-4 w-4 text-blue-200 transition-transform group-hover/phone:scale-110" aria-hidden="true" />{OFFICE_CONTACTS.ottawa.whatsappDisplay}</span>
        </a>
      </div>
    </section>
