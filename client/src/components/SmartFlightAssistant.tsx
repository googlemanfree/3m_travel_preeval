...
export const SmartFlightAssistant = () => {
  ...
  const translations = {
    fr: {
      ...
      contact: "Nos conseillers experts sont joignables directement sur WhatsApp au +1 672 897 2999 ou par e-mail à hello@3mtravelagency.com pour vous assister."
    },
    en: {
      ...
      contact: "Our expert advisors can be reached directly via WhatsApp at +1 672 897 2999 or by email at hello@3mtravelagency.com to assist you."
    },
    es: {
      ...
      contact: "Nuestros asesores expertos están disponibles por WhatsApp en el +1 672 897 2999 o por correo en hello@3mtravelagency.com para ayudarte."
    },
    de: {
      ...
      contact: "Unsere Expertenberater erreichen Sie direkt per WhatsApp unter +1 672 897 2999 oder per E-Mail unter hello@3mtravelagency.com."
    }
  };
