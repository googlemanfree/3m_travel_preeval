...
export default function HeroSection({ onEvalClick, logoUrl, whatsappNumber }: HeroSectionProps) {
  const fadeUp = {
  ...
  return (
    <section
      className="relative py-16 md:py-20 overflow-hidden text-center text-white"
      style={{
