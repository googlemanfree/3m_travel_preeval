...
const quickLinks = [
  ...
  { href: "/mon-espace?section=dossier", label: "Mon dossier", description: "Ouvrir votre dossier actif dans l’espace client", icon: FolderOpen, tone: "bg-indigo-50 text-indigo-700" },
        ...
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2 text-xs font-bold">
              ...
              {dossierNumber ? <a href="/mon-espace?section=dossier" aria-label={`Ouvrir le dossier ${dossierNumber} dans votre espace`} className="rounded-full bg-blue-100 px-3 py-1.5 text-blue-800 hover:bg-blue-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700">#{dossierNumber}</a> : <span className="rounded-full bg-amber-100 px-3 py-1.5 text-amber-800">Aucun dossier actif</span>}
            </div>
          </div>
