...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=cancel]:translate-x-0 data-[swipe=cancel]:transition-[transform,opacity] data-[swipe=cancel]:duration-200 data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[state=closed]:animate-hide data-[state=open]:animate-slideIn data-[state=closed]:opacity-0 sm:data-[state=closed]:animate-fadeOut sm:data-[state=open]:animate-fadeIn",
  {
    variants: {
      variant: {
        default:
...
const Toast = React.forwardRef<React.ElementRef<typeof ToastPrimitives.Root>, ToastProps>(({ className, variant, title, description, ...props }, ref) => {
  return (
