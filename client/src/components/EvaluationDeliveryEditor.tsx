    ...
    <DialogContent className="max-h-[94vh] max-w-6xl overflow-y-auto">
      ...
      {isLoading || !data ? <div className="py-12 text-center text-sm text-slate-500">Chargement du brouillon d’évaluation…</div> : <div className="grid gap-5 xl:grid-cols-[1fr_1.05fr]">
        <div className="space-y-4">
          ...
          <RichTextEditor label="Bloc-notes du conseiller — message d’évaluation" value={message} onChange={setMessage} placeholder="Rédigez ici l’évaluation et les explications personnalisées du candidat…" minHeight="24rem" maxCharacters={8000} sessionToken={sessionToken} templateScope="evaluation_message" />
