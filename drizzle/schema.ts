...
export const evaluations = mysqlTable("evaluations", {
  ...
  secondReviewRequired: boolean("secondReviewRequired").default(false).notNull(),
  secondReviewedAt: timestamp("secondReviewedAt"),
  secondReviewedBy: varchar("secondReviewedBy", { length: 320 }),
  secondReviewNote: text("secondReviewNote"),
...
export const tourismServiceRequests = mysqlTable("tourism_service_requests", {
  ...
  index("idx_tourism_service_requests_status_created").on(table.status, table.createdAt),
