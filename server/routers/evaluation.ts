...
const evaluationInput = z.object({
  ...
  travelReason: z.string().max(1000).optional(),
  availableBudget: z.string().max(50).optional(),
  ...
  priorVisaRefusalCountry: z.string().max(100).optional(),
...
const multiProjectEvaluationInput = z.object({
  ...
  nationality: z.string().max(100).optional(),
  destinationCategory: destinationCategoryEnum,
  destinationCountry: z.string().min(2, "Pays de destination requis").max(100),
  ...
  socialTies: z.string().max(1000).optional(),
