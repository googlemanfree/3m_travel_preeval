...
export const PUBLIC_PAGES: Record<string, PublicMeta> = {
  ...
  "/billets": { title: `Billets d'avion & réservation de vols | ${SITE}`, description: "Recherchez vos vols, comparez les options disponibles et demandez votre réservation avec 3M Travel & Services à Yaoundé. Tarifs et disponibilités confirmés avant paiement.", keywords: ["billets d'avion", "réservation de vol", "3M Booking", "vol Yaoundé", "agence de voyage Cameroun"], heading: "Réservez votre vol avec 3M Travel", lead: "Recherchez votre itinéraire, comparez les options disponibles et demandez votre réservation. Disponibilités et tarifs confirmés avant toute réservation ou paiement." },
  ...
  "/services": { title: `Nos services : visas, voyages et démarches | ${SITE}`, description: "Mobilité internationale, billets d’avion, hôtels, assurance voyage, CNI et passeport, e-Visa, formations et services numériques : tous les services de 3M Travel & Services à Yaoundé.", heading: "Tous les services de 3M Travel & Services", lead: "Mobilité internationale, travel et démarches administratives : choisissez votre besoin et suivez votre dossier avec un seul interlocuteur. Les décisions appartiennent aux autorités et prestataires concernés ; 3M prépare et suit sans garantir de résultat." },
