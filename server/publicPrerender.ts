...
export const PUBLIC_PAGES: Record<string, PublicMeta> = {
  ...
  "/paiement": { title: `Moyens de paiement | ${SITE}`, description: "Carte, Mobile Money, virement bancaire, dépôt sur le numéro de l’agence ou paiement en agence à Yaoundé : tous les moyens de règlement de 3M Travel & Services.", heading: "Moyens de paiement", lead: "Payez en ligne dès que la passerelle est activée, ou par virement, dépôt Mobile Money ou en agence. Un paiement n’est pris en compte qu’après confirmation de réception par l’agence ; vérifiez toujours les coordonnées sur cette page." },
