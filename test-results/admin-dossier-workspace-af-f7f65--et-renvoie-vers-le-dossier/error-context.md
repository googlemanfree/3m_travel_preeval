...
- Name: admin-dossier-workspace.spec.ts >> affiche la file quotidienne de bilans à relire et renvoie vers le dossier
- Location: e2e/admin-dossier-workspace.spec.ts:140:1
...
Call log:
  - waiting for getByRole('tab', { name: 'Bilans à valider' })
