...
## Audit barre de progression du checkout de vol — 13 août 2026

Les captures de `/flight-booking/demo` montrent une progression lisible sur desktop et mobile. L’étape courante est affichée comme « Étape 2 sur 4 — Informations passager », avec 33 %, la première étape validée et les étapes de confirmation visibles à droite. La barre conserve une mise en page adaptée à 375×812 : les intitulés abrégés restent lisibles et la jauge ne provoque pas de débordement horizontal. L’étape « Confirmation finale » devient active lorsque la modale de récapitulatif est ouverte, puis « Réservation confirmée » après validation.
